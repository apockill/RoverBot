...
class Encoder:
    ...
    def __init__(self, pinA, pinB):
        ...
        GPIO.add_event_detect(pinA, GPIO.BOTH, callback = self.pinChangeEvent, bouncetime=0)
        GPIO.add_event_detect(pinB, GPIO.BOTH, callback = self.pinChangeEvent, bouncetime=0)
