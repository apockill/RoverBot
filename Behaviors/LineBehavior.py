...
class FollowLine:
    ...
    def moveTowards(self, point):
        ...
        left  = self.targetSpeed*.2 + speed * xMag  # Where -1 xmag will lower left turning speed
        right = self.targetSpeed*.2 - speed * xMag  # Where -1 xmag will raise the right turning speed
