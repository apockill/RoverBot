...
class FollowLine:
    ...
    def moveTowards(self, point):
        ...
        lSpeed = self.targetSpeed*.4 + speed * xMag  # Where -1 xmag will lower left turning speed
        rSpeed = self.targetSpeed*.4 - speed * xMag  # Where -1 xmag will raise the right turning speed
